...
<html><head><title>Bercy Gnosis Pay</title>
<style>
...
<h1>🔺 Bercy Gnosis Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on Gnosis Chain Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy Gnosis Pay", network: "Gnosis Chain Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy Gnosis Pay running on port " + PORT));
